...
<img src="logo.png" alt="Cover image" width="285" height="285" align="right" style="margin: 1em"/> This repository contains the source of **Experimentation with LSTM networks for Time series forecasting** an app to carry out simple experiments of the use of LSTM networks in time series forecasting. It allows users to solves univariate and multivariate regression problems by testing different set of features, and comparing the effectiveness of the obtained results.
